...
class Index extends \Magento\Framework\App\Action\Action
{
	...
	{
		$custom_variables = 'var custom_variables = '.$this->serializer->serialize($this->getCustomVariables());
	...
	{
		if (
			'checkout/onepage/success/' === str_replace($this->urlinterface->getBaseUrl(), '', $this->urlinterface->getCurrentUrl())
		) {
			return true;
		}
